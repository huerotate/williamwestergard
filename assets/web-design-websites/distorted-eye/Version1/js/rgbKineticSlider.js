(function() {
    ...
    window.rgbKineticSlider = function(options) {
        ...
        options.slideTransitionDuration = options.hasOwnProperty('slideTransitionDuration') ? options.slideTransitionDuration : 3;
        ...
        options.transitionSpriteRotation= options.hasOwnProperty('transitionSpriteRotation') ? options.transitionSpriteRotation : 90;
                ...
                onUpdate: function() {
                    ...
                    if( is_loaded === true) {
                        ...
                        if(options.textsRgbEffect == true) {
                            ...
                            if(timelineTransition.progress() < 0.8) {
            ...
            // if subtitles inactive and title active
                ...
                timelineTransition
                    ...
                    .to(slideImages,  options.slideTransitionDuration, {
                            alpha: 0,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.9)
